...
- Kirim pesan hanya ke pelanggan yang memberi izin
- Segmentasikan audiens
- Jangan mengirim pesan terlalu sering
- Buat pesan jelas dan relevan
- Sediakan cara berhenti menerima pesan
- Hindari klaim berlebihan
- Gunakan jalur resmi untuk skala besar
...
- Memakai opt-in pelanggan
- Mengirim konten yang diharapkan pelanggan
- Menggunakan template resmi jika memakai API
...
- Lebih stabil untuk skala besar
- Bisa dipakai banyak admin
- Ada template message
