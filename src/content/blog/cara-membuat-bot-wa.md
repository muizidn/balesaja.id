...
- Menyaring komplain sebelum masuk ke admin

Jika tujuannya customer service awal, kamu bisa memakai kerangka di [chatbot WhatsApp untuk bisnis](/blog/chatbot-whatsapp-untuk-bisnis/).

## 2. Kumpulkan pertanyaan yang paling sering masuk

Ambil 20-50 chat pelanggan terakhir, lalu kelompokkan pertanyaannya.

Biasanya kategori awal berisi:
...
1. Bot menyapa pelanggan.
2. Bot menawarkan pilihan bantuan.
3. Pelanggan memilih kategori.
4. Bot menjawab atau meminta data tambahan.
5. Jika belum selesai, bot meneruskan ke admin.
...
**WhatsApp Business App.** Cocok untuk bisnis kecil yang butuh quick replies, greeting message, away message, dan label.

**Platform chatbot WhatsApp.** Cocok jika ingin membuat flow tanpa coding.
...
- Ada komplain
- Ada refund atau retur
- Bot tidak memahami pertanyaan
- Pelanggan mengulang pertanyaan yang sama

Handover yang baik membawa ringkasan chat, bukan hanya meneruskan pesan kosong.

## 6. Uji bot sebelum dipakai publik

Sebelum dipasang di nomor utama, uji dengan skenario nyata:

- Pelanggan bertanya harga
- Pelanggan ingin order
- Pelanggan ingin komplain
- Pelanggan salah mengetik
- Pelanggan mengirim pesan panjang
...
- Integrasi minim
- Risiko tidak stabil jika memakai cara tidak resmi
- Sulit dipakai untuk reporting
...
Cara membuat bot WA yang baik dimulai dari alur customer service, bukan dari teknologi. Tentukan tujuan, kumpulkan pertanyaan umum, buat flow sederhana, pilih tools yang sesuai, lalu siapkan handover ke admin.

Setelah bot berjalan, ukur performanya dengan [metrik customer service WhatsApp](/blog/metrik-customer-service-whatsapp/).
